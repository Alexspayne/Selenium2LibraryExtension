...
Get Element Size
    [Documentation]    Get Element Size
...
Get Empty Element Size
    [Documentation]    Get Empty Element Size
...
Get Child
    ...
    [Tags]  S2Lext
    ${parent_div} =  Get Webelement  div_id
    Get Child  ${parent_div}  //a[@id='some_id']
    Run Keyword And Expect Error    No Element was found by relative XPath //div
    ...      Get Child  ${parent_div}  //div
